...
#if CPARSEDEBUG || YYERROR_VERBOSE || 1
/* YYTNAME[SYMBOL-NUM] -- String name of the symbol SYMBOL-NUM.
   First, the terminals, then, starting at YYNTOKENS, nonterminals.  */
static const char *const yytname[] =
{
  "$end", "error", "$undefined", "ARGWORD", "STRING", "KW_BREAK",
  "KW_DEL", "KW_WDEL", "KW_SYMS", "KW_REGS", "KW_SI", "KW_CONTINUE",
  "KW_STEP", "KW_N", "KW_UP", "KW_TB", "KW_RUN", "KW_KILL", "KW_HELP",
  "KW_QUIT", "KW_X", "KW_DIS", "KW_LIST", "KW_LINES", "KW_LEAK", "KW_SHOW",
  "KW_WATCH", "KW_PRINT", "KW_SET", "KW_SETPRINTPRETTY", "KW_THREAD",
  "KW_PROCESS", "$accept", "line", YY_NULLPTR
};
#endif
...
static void
yy_symbol_value_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, debugger_t *dbg, cmd_action_t *action)
{
  FILE *yyoutput = yyo;
  YYUSE (yyoutput);
  YYUSE (dbg);
...
static void
yy_symbol_print (FILE *yyo, int yytype, YYSTYPE const * const yyvaluep, debugger_t *dbg, cmd_action_t *action)
{
  YYFPRINTF (yyo, "%s %s (",
             yytype < YYNTOKENS ? "token" : "nterm", yytname[yytype]);

  yy_symbol_value_print (yyo, yytype, yyvaluep, dbg, action);
  YYFPRINTF (yyo, ")");
}
...
static void
yy_reduce_print (yytype_int16 *yyssp, YYSTYPE *yyvsp, int yyrule, debugger_t *dbg, cmd_action_t *action)
{
...
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, debugger_t *dbg, cmd_action_t *action)
{
  YYUSE (yyvaluep);
  YYUSE (dbg);
  YYUSE (action);
  ...
  if (!yyerrstatus)
    {
      ++yynerrs;
#if ! YYERROR_VERBOSE
      yyerror (dbg, action, YY_("syntax error"));
#else
  ...
  for (;;)
    {
      ...
      yydestruct ("Error: popping",
                  yystos[yystate], yyvsp, dbg, action);
      YYPOPSTACK (1);
      yystate = *yyssp;
      YY_STACK_PRINT (yyss, yyssp);
    }
